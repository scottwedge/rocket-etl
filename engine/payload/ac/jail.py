...
def process_job(**kwparameters):
    ...
    target, local_directory, file_connector, local_cache_filepath, loader_config_string, destinations, destination_filepath, destination_directory = default_job_setup(job, use_local_files)
